...
from log_funcs_unc import log_probability
...
outdir = 'average_system_unc_5/Outdir_lens_reconstruction'
...
im = ax.matshow(np.log10(image_real), origin='lower', cmap='magma', vmin=-3.5, vmax=0)
...
plt.figure()
fig = corner.corner(flat_samples, labels=["$ra$", "$dec$"], truths=[source_x, source_y], range=[(-1.0,1.0),(-1.0,1.0)])
